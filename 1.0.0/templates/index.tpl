			...
			<ul class="PG_{$PLUGIN_NAME}_contentnews">
				<li>
					...
					<div class="PG_{$PLUGIN_NAME}_content">
						<p class="PG_{$PLUGIN_NAME}_title">TCB Courier</p>
				...
				<li>
					...
					<div class="PG_{$PLUGIN_NAME}_content">
						<p class="PG_{$PLUGIN_NAME}_title">The Hummus Guy</p>
						<div class="PG_{$PLUGIN_NAME}_rating">39 reviews</div>
						<p class="PG_{$PLUGIN_NAME}_content_desc">San Francisco</p>
						<p class="PG_{$PLUGIN_NAME}_content_desc">Neighborhood: <a href="#">Bernal Heights</a></p>
						<p class="PG_{$PLUGIN_NAME}_content_desc">Category: <a href="#">Ethnic Food</a></p>
				...
				<li>
					<span><img src="images/pg_tree_p.gif" alt="Plus Sign" style="display:visible" /><img src="images/pg_tree_m.gif" alt="Minus Sign" style="display:none" /></span>
					<div class="PG_{$PLUGIN_NAME}_content">
						<p class="PG_{$PLUGIN_NAME}_title">East & West Gourmet Afghan Foods</p>
						<div class="PG_{$PLUGIN_NAME}_rating">31 reviews</div>
						<p class="PG_{$PLUGIN_NAME}_content_desc">San Francisco</p>
						<p class="PG_{$PLUGIN_NAME}_content_desc">Neighborhood: <a href="#">Bernal Heights</a></p>
						<p class="PG_{$PLUGIN_NAME}_content_desc">Category: <a href="#">Ethnic Food</a></p>
						<p class="PG_{$PLUGIN_NAME}_toggle_content" style="display:none">	
				...
				<li>
					<span><img src="images/pg_tree_p.gif" alt="Plus Sign" style="display:visible" /><img src="images/pg_tree_m.gif" alt="Minus Sign" style="display:none" /></span>
					<div class="PG_{$PLUGIN_NAME}_content">
						<p class="PG_{$PLUGIN_NAME}_title">Jasmine Rae Bakery</p>
						<div class="PG_{$PLUGIN_NAME}_rating">46 reviews</div>
						<p class="PG_{$PLUGIN_NAME}_content_desc">San Francisco</p>
						<p class="PG_{$PLUGIN_NAME}_content_desc">Neighborhood: <a href="#">Mission</a></p>
				...
				<li>
					<span><img src="images/pg_tree_p.gif" alt="Plus Sign" style="display:visible" /><img src="images/pg_tree_m.gif" alt="Minus Sign" style="display:none" /></span>
					<div class="PG_{$PLUGIN_NAME}_content">
						<p class="PG_{$PLUGIN_NAME}_title">moonbabycakes</p>
